...
name: tldraw-migrate
description: |
  USE WHEN: user wants to migrate a project to a newer version of the tldraw SDK, upgrade tldraw packages, or fix TypeScript errors after a tldraw upgrade.
  DO NOT USE WHEN: user is asking general tldraw documentation questions, creating new tldraw examples, or changing the tldraw repo itself without an SDK migration.
