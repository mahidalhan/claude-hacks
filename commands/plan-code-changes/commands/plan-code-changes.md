---
description: Create detailed implementation plan for code changes
---
...
Create a plan markdown file within the project folder, prefixed with plan- and followed by a slug describing the plan.
